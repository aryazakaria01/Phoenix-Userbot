...
async def bot_ver(event):
    ...
    if which("git") is not None:
        ...
        await event.edit(
            ...
            f"heads/Phoenix-Userbot-0-x634i7u1"
            "\n**⚜-**Revisi:**\n "
            f"{revout}"
        )
    else:
...
async def amireallyalive(alive):
    ...
    output = (
        f"**ㅤㅤ  ╭─━━═━═━═━═━━─╮**\n"
        f"**       ⊏┊[⚡ᴘʜᴏᴇɴɪx-ᴜsᴇʀʙᴏᴛ⚡](t.me/sekolahwibu) ⊨〛💨 **\n"
        f"**ㅤㅤ  ╰─━━═━═━═━═━━─╯**\n"
        f"╭╼════════════════════╾╮\n"
        f"│    ⇱  𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 𝐌𝐲 𝐏𝐫𝐨𝐟𝐢𝐥𝐞 ⇲ \n"
        f"┟╼════════════════════╾┤\n"
        f"╟◈ 😼  `ᴘʜᴏᴇɴɪx     :` {DEFAULTUSER}\n"
        f"╟◈ 🔎  `ᴜsᴇʀɴᴀᴍᴇ :` @{user.username}\n"
        f"╟◈ ⚙️  `ᴛᴇʟᴇᴛʜᴏɴ :` v. {version.__version__}\n"
        f"╟◈ 🐍  `ᴘʏʜᴛᴏɴ   :` v. {python_version()}\n"
        f"╟◈ 👾  `ʙᴏᴛ ᴠᴇʀ  :` v. {BOT_VER}\n"
        f"╟◈ 🛠️  `ʙʀᴀɴᴄʜ   :` {UPSTREAM_REPO_BRANCH}\n"
        f"╟◈ 💻  `sʏsᴛᴇᴍ   :` Ubuntu 20.10\n"
        f"╟◈ 📂  `ᴘʟᴜɢɪɴ  :` {len(modules)} Plugins\n"
        f"┞╼════════════════════╾┤\n"
        f"├◈ **{LYNX_TEXT_CUSTOM}**\n"
        f"╰╼════════════════════╾╯\n"
...
async def redis(alive):
    ...
    await alive.edit("⚡𝗣𝗵𝗼𝗲𝗻𝗶𝘅🐈𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡𝗣𝗵𝗼𝗲𝗻𝗶🐈𝘅-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡𝗣𝗵𝗼𝗲𝗻🐈𝗶𝘅-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡𝗣𝗵𝗼𝗲🐈𝗻𝗶𝘅-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡𝗣𝗵𝗼🐈𝗲𝗻𝗶𝘅-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡𝗣𝗵🐈𝗼𝗲𝗻𝗶𝘅-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡𝗣🐈𝗵𝗼𝗲𝗻𝗶𝘅-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡🐈𝗣𝗵𝗼𝗲𝗻𝗶𝘅-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡")    
    await alive.edit("🐈𝗣𝗵𝗼𝗲𝗻𝗶𝘅-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡")
    ...
    output = (
        f"**ㅤㅤ  ╭─━━═━═━═━═━━─╮**\n"
        f"**       ⊏┊[⚡ᴘʜᴏᴇɴɪx-ᴜsᴇʀʙᴏᴛ⚡](t.me/Badboyanim) ⊨〛💨 **\n"
        f"**ㅤㅤ  ╰─━━═━═━═━═━━─╯**\n"
        f"╭╼════════════════════╾╮\n"
        f"│    ⇱  𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 𝐌𝐲 𝐏𝐫𝐨𝐟𝐢𝐥𝐞 ⇲ \n"
        f"┟╼════════════════════╾┤\n"
        ...
        f"╟◈ 📂  `ᴘʟᴜɢɪɴ  :` {len(modules)} Plugins\n"
        f"┞╼════════════════════╾┤\n"
        f"├◈ **ᴅᴏɴ'ᴛ ғᴏʀɢᴇᴛ ᴛᴏ sᴜᴘᴘᴏʀᴛ ᴏᴜʀ**\n"
        f"│    **ᴜsᴇʀʙᴏᴛ, ʜᴏᴡ ᴛᴏ ᴘʀᴇss ʙᴇʟᴏᴡ.**\n"
        f"╰╼════════════════════╾╯\n"
